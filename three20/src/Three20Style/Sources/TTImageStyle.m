...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
    _imageDelegate.delegate = nil;
  TT_RELEASE_SAFELY(_imageDelegate);
...
-(void)setImageURL:(NSString *)imageURL {
    if (!_imageDelegate) {
        _imageDelegate = [[SDImageDelegate alloc]init];
        _imageDelegate.delegate =self;
    }
    TT_RELEASE_SAFELY(_imageURL);
    _imageURL = [imageURL retain];
    BOOL ret = [_imageDelegate loadImageWithURL:_imageURL];
    if (ret)
    {
        self.image = _imageDelegate.image;
    }
}
...
{
    if ([downloader.lastKey isEqualToString:self.imageURL]) {
