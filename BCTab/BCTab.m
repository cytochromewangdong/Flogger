...
@synthesize rightBorder=_rightBorder, background=_background;

- (id)initWithIconImageName:(NSString *)imageName SelectedImage:(NSString*) selectedImageName{
	if (self = [super init]) {
...
- (void)drawRect:(CGRect)rect {
	/*if (self.selected) {
		[self.background drawAtPoint:CGPointMake(0, 2)];//[self.background drawAtPoint:CGPointMake(0, 2)]
