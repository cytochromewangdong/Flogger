...
#import "FloggerKeyboardControls.h"
...
@interface FloggerKeyboardControls ()
...
@implementation FloggerKeyboardControls
...
- (id)init
{
    if (self = [super init])
    {
        ...
        // Create toolbar
        self.toolbar = [[[UIToolbar alloc] initWithFrame:self.frame] autorelease];
        self.toolbar.barStyle = self.barStyle;
        self.toolbar.backgroundColor = [UIColor clearColor];
        
        // Setup segmented controls
        self.segmentedPreviousNext = [[[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:self.previousTitle, self.nextTitle, nil]] autorelease];
        ...
        UIBarButtonItem *barSegment = [[[UIBarButtonItem alloc] initWithCustomView:self.segmentedPreviousNext] autorelease];
        
        // Create spacing
        UIBarButtonItem *flex = [[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil] autorelease];
        
        // Create done button
        self.buttonDone = [[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(buttonDonePressed:)] autorelease];
